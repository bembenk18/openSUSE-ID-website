          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Komunitas Terbuka</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Bagian dari Komunitas Global</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Berbagi Pengetahuan</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Open Source Spirit</h3>
                <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-xl p-8 mb-16">
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Kegiatan Kami</h3>
